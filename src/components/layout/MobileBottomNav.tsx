import { Home, Newspaper, Ticket, Users, ShoppingBag, User } from "lucide-react";
...
export function MobileBottomNav({ currentPath }: MobileBottomNavProps) {
  ...
  const navItems = [{
    ...
    icon: isAuthenticated ? User : ShoppingBag,
    label: isAuthenticated ? "Profile" : "More",
    path: isAuthenticated ? "/profile" : "/more"
  }];
